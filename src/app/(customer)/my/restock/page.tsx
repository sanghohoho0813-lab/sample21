  ...
  return (
    <div className="space-y-5">
      <div className="rounded-cardlg border border-brand-accent/30 bg-brand-accent/5 p-5 flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        {store.role !== "customer" && <Link href="/ax/inventory" className="tap text-[0.82rem] font-bold text-brand-accent hover:underline underline-offset-2 inline-flex items-center gap-0.5 whitespace-nowrap">Demand Radar 보기<ChevronRight size={14} /></Link>}
      </div>
